...
(defn collection
  [name]
  (str "com.etzhayyim.wadachi." name))

(def cell-specs {
  :route_planning {:legacy-cell "route-planning"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "route_planning")]
     :required-gates common-gates
     :trigger "manifest cell route_planning"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :motion_control {:legacy-cell "motion-control"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "motion_control")]
     :required-gates common-gates
     :trigger "manifest cell motion_control"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :obstacle_avoidance {:legacy-cell "obstacle-avoidance"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "obstacle_avoidance")]
     :required-gates common-gates
     :trigger "manifest cell obstacle_avoidance"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :safety_monitoring {:legacy-cell "safety-monitoring"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "safety_monitoring")]
     :required-gates common-gates
     :trigger "manifest cell safety_monitoring"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :telemetry_log {:legacy-cell "telemetry-log"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "telemetry_log")]
     :required-gates common-gates
     :trigger "manifest cell telemetry_log"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
